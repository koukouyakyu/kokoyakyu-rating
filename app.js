(() => {
  ...
  const state = {
    ...
    ranking: [], prefs: [], proposals: [], editHistory: [], ready: false, historyYears: '1', compareStartDate: '', compareEndDate: '', selectedSchoolKey: null, schoolSearchHits: [], recordSearchHits: [], compareSchoolKeys: [], rankCompareSearchHits: [], showDuplicatesOnly: false, duplicateGroups: [], prefExpanded: false, rankingPage: 1, rankingPageSize: 20, rankSnapshotCache: new Map(), deferredRenderHandle: null, duplicateCacheDirty: true, matchSortCache: null,
